...
namespace LoreHub.DialogSystem.Tests.DialogOptionTests
{
    public class DialogOption_Select
    {
        ...
        public void SelectOption_Should_RaiseEvent()
        {
            ...
            DialogOptionNext<TestContent> optionToSelect = new DialogOptionNext<TestContent>(Guid.NewGuid(), new TestContent(), DialogNode<TestContent>.CreateNew(content: new TestContent(), dialogOptions: new List<DialogOptionNext<TestContent>> { }));
        ...
        public void SelectOption_Should_ContaintNextNode()
        {
            ...
            DialogOptionNext<TestContent> optionToSelect = new DialogOptionNext<TestContent>(Guid.NewGuid(), new TestContent(), nextNode);
